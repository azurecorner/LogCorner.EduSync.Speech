...
namespace LogCorner.EduSync.Speech.ServiceBus
{
    ...
    public class AzureServiceBus : /*IAzureServiceBus */ IServiceBusProducer
    {
        ...
        public async Task SendMessage<T>(T item)
        {
     ...
     new TokenRequestContext(new[] { "https://servicebus.azure.net/.default" }), CancellationToken.None);
        ...
        public async Task ReceiveAsync(string[] topic, CancellationToken stoppingToken, bool runAlawys = true)
        {
